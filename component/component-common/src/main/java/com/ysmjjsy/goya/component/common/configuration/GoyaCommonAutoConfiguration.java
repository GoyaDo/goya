...
import com.ysmjjsy.goya.component.json.configuration.GoyaJsonAutoConfiguration;
...
@Slf4j
@AutoConfiguration
@AutoConfigureAfter(GoyaJsonAutoConfiguration.class)
@Import({
        SpringUtil.class,
})
@EnableAsync
...
public class GoyaCommonAutoConfiguration {
    ...
    public ApplicationContextHolder applicationContextHolder() {
        ...
        log.trace("[Goya] |- component [common] |- bean [applicationContextHolder] register.");
        return bean;
    }
