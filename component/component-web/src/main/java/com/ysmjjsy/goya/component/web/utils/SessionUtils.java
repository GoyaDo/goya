...
public class SessionUtils {
     ...
     * 解析 Session ID
     * <p>
     * 如果请求中有 X_GOYA_SESSION_ID 头，那么则返回 SessionId，意味着前后端加密有效。
    ...
    public static String analyseSessionId(HttpServletRequest httpServletRequest) {
        ...
        if (StringUtils.isBlank(sessionId)) {
            sessionId = HeaderUtils.getGoyaSessionId(httpServletRequest);
        }
        return sessionId;
    }
    ...
    public static String analyseSessionId(ServerHttpRequest serverHttpRequest) {
        ...
        if (StringUtils.isBlank(sessionId)) {
            sessionId = HeaderUtils.getGoyaSessionId(serverHttpRequest);
        }
        return sessionId;
    }
    ...
    public static String analyseSessionId(HttpInputMessage httpInputMessage) {
        ...
        if (StringUtils.isBlank(sessionId)) {
            sessionId = HeaderUtils.getGoyaSessionId(httpInputMessage);
        }
        return sessionId;
    }
    ...
    public static boolean isCryptoEnabled(HttpServletRequest httpServletRequest, String sessionId) {
        return HeaderUtils.hasGoyaSessionIdHeader(httpServletRequest) && StringUtils.isNotBlank(sessionId);
    }
    ...
    public static boolean isCryptoEnabled(HttpInputMessage httpInputMessage, String sessionId) {
        return HeaderUtils.hasGoyaSessionIdHeader(httpInputMessage) && StringUtils.isNotBlank(sessionId);
    }
}
