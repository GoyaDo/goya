...
public class WebScanAutoConfiguration {

    private static final Logger log = LoggerFactory.getLogger(WebScanAutoConfiguration.class);

    @PostConstruct
    public void postConstruct() {
        log.debug("[Goya] |- component [web] WebScanAutoConfiguration auto configure.");
    }
