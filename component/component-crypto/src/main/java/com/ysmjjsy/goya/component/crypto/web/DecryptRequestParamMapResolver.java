package com.ysmjjsy.goya.component.crypto.web;

import com.ysmjjsy.goya.component.crypto.annotation.Crypto;
...
public class DecryptRequestParamMapResolver implements HandlerMethodArgumentResolver {
    ...
    private boolean isOauthTokenRequest(String uri, String method) {
        return StringUtils.equals(uri, "/oauth2/token") && StringUtils.equalsIgnoreCase(method, HttpMethod.POST.name());
    }
