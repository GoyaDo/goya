...
public class GoyaSecurityContext {
    ...
    public static GoyaSecurityContext getInstance() {
        GoyaSecurityContext goyaSecurityContext = Singleton.get(GoyaSecurityContext.class);
        return Objects.requireNonNullElseGet(goyaSecurityContext, GoyaSecurityContext::new);
    }
}
