package com.ysmjjsy.goya.security.authentication.client.processor;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.Module;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ysmjjsy.goya.security.authentication.client.processor.jackson2.GoyaJackson2Module;
import com.ysmjjsy.goya.security.authentication.client.processor.jackson2.OAuth2TokenJackson2Module;
...
public class OAuth2JacksonProcessor {
    ...
    public OAuth2JacksonProcessor() {
        ...
        objectMapper.registerModules(new GoyaJackson2Module());
    ...
    public Map<String, Object> parseMap(String data) {
        try {
            ...
            log.error("[Goya] |- OAuth2 jackson processing parseMap catch error {}", ex.getMessage());
    ...
    public String writeMap(Map<String, Object> data) {
        try {
            ...
            log.error("[Goya] |- OAuth2 jackson processing writeMap catch error {}", ex.getMessage());
            throw new IllegalArgumentException(ex.getMessage(), ex);
        }
    }
}
