...
import com.ysmjjsy.goya.security.core.exception.SocialCredentialsParameterBindingFailedException;
...
public class OAuth2SocialCredentialsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public OAuth2SocialCredentialsAuthenticationProvider(OAuth2AuthorizationService authorizationService,
                                                         OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator,
                                                         UserDetailsService userDetailsService,
                                                         IdentityProperties identityProperties) {
        super(authorizationService, userDetailsService, identityProperties);
    ...
    protected UserDetails retrieveUser(Map<String, Object> additionalParameters) throws AuthenticationException {
        String source = (String) additionalParameters.get(SecurityConstants.SOURCE);
        ...
        try {
            ...
            UserDetails userDetails = enhanceUserDetailsService.loadGoyaUserBySocial(source, accessPrincipal);
            if (userDetails == null) {
            ...
            log.error("[Goya] |- User name can not found for：[{}]", source);
            throw ex;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!registeredClient.getAuthorizationGrantTypes().contains(GoyaGrantType.SOCIAL)) {
        ...
        OAuth2Authorization.Builder authorizationBuilder = OAuth2Authorization.withRegisteredClient(registeredClient)
                ...
                .authorizationGrantType(GoyaGrantType.SOCIAL)
        ...
        log.debug("[Goya] |- Social Credential returning OAuth2AccessTokenAuthenticationToken.");
    ...
    public boolean supports(Class<?> authentication) {
        ...
        log.trace("[Goya] |- Resource Owner Password Authentication is supports! [{}]", supports);
        return supports;
    }
