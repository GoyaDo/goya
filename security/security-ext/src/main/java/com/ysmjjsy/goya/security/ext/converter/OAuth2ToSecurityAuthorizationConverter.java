...
/**
 * <p>Description: OAuth2Authorization 转 SecurityAuthorization 转换器 </p>
 *
 * @author goya
 * @since 2023/5/21 20:57
 */
public class OAuth2ToSecurityAuthorizationConverter extends AbstractOAuth2EntityConverter<OAuth2Authorization, SecurityAuthorization> {

    public OAuth2ToSecurityAuthorizationConverter(OAuth2JacksonProcessor jacksonProcessor) {
        super(jacksonProcessor);
    }

    @Override
    public SecurityAuthorization convert(OAuth2Authorization authorization) {
        SecurityAuthorization entity = new SecurityAuthorization();
