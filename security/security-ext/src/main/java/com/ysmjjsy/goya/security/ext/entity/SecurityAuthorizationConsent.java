...
@Cacheable
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = SecurityExtConstants.REGION_CLIENT_AUTHORIZATION_CONSENT)
public class SecurityAuthorizationConsent implements com.ysmjjsy.goya.component.common.pojo.domain.Entity {
