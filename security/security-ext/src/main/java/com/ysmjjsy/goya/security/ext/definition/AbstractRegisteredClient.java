...
import com.ysmjjsy.goya.component.core.jackson2.deserializer.CommaDelimitedStringToSetSerializer;
import com.ysmjjsy.goya.component.core.jackson2.deserializer.SetToCommaDelimitedStringDeserializer;
...
public abstract class AbstractRegisteredClient extends BaseJpaEntity implements RegisteredClientDetails {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof AbstractRegisteredClient that)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
