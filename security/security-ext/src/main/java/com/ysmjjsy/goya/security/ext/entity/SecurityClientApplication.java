...
import com.ysmjjsy.goya.security.core.enums.ApplicationType;
...
@Table(name = "security_client_application", indexes = {
        @Index(name = "security_client_application_id_idx", columnList = "id"),
        @Index(name = "security_client_application_cid_idx", columnList = "client_id")})
@Cacheable
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = SecurityExtConstants.REGION_CLIENT_APPLICATION)
public class SecurityClientApplication extends AbstractOAuth2RegisteredClient {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof SecurityClientApplication that)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
