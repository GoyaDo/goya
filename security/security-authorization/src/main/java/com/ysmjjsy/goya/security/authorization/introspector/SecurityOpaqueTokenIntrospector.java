package com.ysmjjsy.goya.security.authorization.introspector;
...
/**
 * <p>自定义 OpaqueTokenIntrospector</p>
...
public class SecurityOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public SecurityOpaqueTokenIntrospector(OAuth2ResourceServerProperties resourceServerProperties) {
    ...
    private static String getIntrospectionUri(OAuth2ResourceServerProperties resourceServerProperties) {
        String introspectionUri = GoyaSecurityContext.getInstance().getTokenIntrospectionUri();
    ...
    private OAuth2AuthenticatedPrincipal convertClaimsSet(Map<String, Object> claims) {
        ...
        claims.computeIfPresent(SecurityConstants.AUTHORITIES, (k, v) -> {
            if (v instanceof ArrayList) {
                ...
                values.forEach(value -> authorities.add(new GoyaGrantedAuthority(value)));
            }
            return v;
        });
