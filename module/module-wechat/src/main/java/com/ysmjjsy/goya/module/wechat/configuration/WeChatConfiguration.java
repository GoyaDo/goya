...
import com.ysmjjsy.goya.module.wechat.app.service.WxAppService;
...
public class WeChatConfiguration {
    ...
    static class WxAppConfiguration {
        ...
        @ConditionalOnMissingBean
        public WxAppService wxAppService(WxappProcessor wxappProcessor) {
            WxAppService wxAppService = new WxAppService(wxappProcessor);
