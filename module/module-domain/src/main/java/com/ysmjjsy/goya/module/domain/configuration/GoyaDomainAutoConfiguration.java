package com.ysmjjsy.goya.module.domain.configuration;

import com.ysmjjsy.goya.component.bus.api.GoyaBus;
import com.ysmjjsy.goya.module.domain.command.CommandInvoker;
import com.ysmjjsy.goya.module.domain.command.OneTransactionCommandInvoker;
import com.ysmjjsy.goya.module.domain.dispatcher.DefaultDomainEventDispatcher;
import com.ysmjjsy.goya.module.domain.dispatcher.DomainEventDispatcher;
...
@AutoConfiguration
@AutoConfigureAfter
public class GoyaDomainAutoConfiguration {
