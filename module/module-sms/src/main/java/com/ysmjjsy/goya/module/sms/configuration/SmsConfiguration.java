...
import com.ysmjjsy.goya.module.sms.api.SmsApi;
...
public class SmsConfiguration {
    ...
    public SmsApi smsService(VerificationCodeStampManager verificationCodeStampManager) {
        SmsApi smsService = new SmsApi(verificationCodeStampManager);
