...
@Table(name = "sys_tenant_datasource",
        ...
        indexes = {@Index(name = "goya_tenant_datasource_id_idx", columnList = "datasource_id")})
@Cacheable
@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = DbConstants.REGION_SYS_TENANT_DATASOURCE)
public class SysTenantDataSource extends BaseJpaEntity {
