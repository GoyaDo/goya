...
import com.ysmjjsy.goya.module.identity.manage.UserStatusEventManager;
...
public class KafkaConfiguration {
    ...
    @Bean
    @Order(Integer.MAX_VALUE - 2)
    @ConditionalOnBean(UserStatusEventManager.class)
    public RemoteAccountStatusEventManager userStatusEventManager() {
