...
import com.ysmjjsy.goya.module.justauth.api.JustAuthApi;
...
public class JustAuthConfiguration {
    ...
    @ConditionalOnMissingBean
    public JustAuthApi justAuthService(JustAuthProcessor justAuthProcessor) {
        JustAuthApi justAuthAccessHandler = new JustAuthApi(justAuthProcessor);
